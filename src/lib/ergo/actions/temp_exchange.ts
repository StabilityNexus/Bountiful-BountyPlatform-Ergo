...
export async function temp_exchange(
    ...
    contractOutput.setAdditionalRegisters({
        ...
        R6: SColl(SLong, [BigInt(bounty.total_submissions), BigInt(bounty.refund_counter), BigInt(bounty.auxiliar_exchange_counter + token_amount)]).toHex(),                                 // Tokens sold counter
