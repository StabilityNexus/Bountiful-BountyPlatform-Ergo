        ...
        <nav class="desktop-nav">
            <ul class="nav-links">
                ...
                <li class={activeTab === 'myBounties' ? 'active' : ''}>
                    <a href="#" on:click={() => changeTab('myBounties')}>
                        My Bounties
                    </a>
                </li>
            ...
            {#if $address}
                <div class="user-info">
                    ...
                    <div class="badge-container">
                        ...
                        {/if}
                        {#if $bounty_token_amount}
                            <Badge style="background-color: orange; color: black; font-size: 0.9em;">{$bounty_token_amount}</Badge>
                        {/if}
                    </div>
                </div>
...
<div class="bottom-left">
    ...
    <a class="github-button" href="https://github.com/StabilityNexus/BountyPlatform-Ergo" target="_blank">
